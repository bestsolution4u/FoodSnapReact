...
class Login extends React.Component {
    ...
    _checkLoggedIn = async () => {
        try {
            ...
            if (isLoggedIn) {
                let routeName = RouteNames.ProfileScreen;
                if (!this.props.hasVerifiedPhone) {
                    routeName = RouteNames.PhoneVerificationScreen;
                    if (!this.props.user.phone) {
                        routeName = RouteNames.EditPhoneScreen;
                    }
                }
